...
enum class MyFormKeys {
    ...
    SWITCH, SLIDER, RANGE_SLIDER,DNI, APE_PAT, APE_MAT, FECHA, TIME,
    TIME_TOLER, MATERIALES, VALIDINSCRIP, ASISSUBACT, ENTSAL, OFFLINE,
    CUI,TIPOCUI,MATERENTRE,HORAREG,MODFH,ACTIVIDADID,EVENTOID,MATRICULAID,
}
